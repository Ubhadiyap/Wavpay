...
public class RxSPTool {
    ...
    public final static String CONFIG = "tools";
    /**
     * 注册Set_Cookie
     *
     * @param value
     */
    public static void setRegisterSetCookie(Context context, String value) {
        Log.d("SharedPreferenceTools", value + "==-------------------------");
        SharedPreferences sharedPreferences = context.getSharedPreferences(CONFIG, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(Set_Cookie, value);
        editor.commit();
    }

    public static String getSetCookieRegisterSP(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(CONFIG, Context.MODE_PRIVATE);
