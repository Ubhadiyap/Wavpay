...
public class OrderRepayBorrowRepayListAdapter extends BaseAdapter {
    ...
    public OrderRepayBorrowRepayListAdapter(List<Uc_Quick_RefundActLoan_ListModel> listModel, Activity activity, RepayBorrowRepayListAdapterListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mActivity.getLayoutInflater().inflate(R.layout.item_order_repay, null);
        ...
        if (mListener != null) {
            if (mListModel != null && mListModel.size() > 0) {
                ...
                for (int i = 0; i < mListModel.size(); i++) {
                    ...
                    if (model.isCanSelect() && model.isSelect()) {
                        String id = mListModel.get(i).getId();
