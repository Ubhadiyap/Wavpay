 ...
 */
public class SDSimpleProjectDetailMultiItemView extends LinearLayout
{
	public TextView inverstdetail_item_tv_left;
	public TextView inverstdetail_item_tv_right;

	public SDSimpleProjectDetailMultiItemView(Context context)
	{
		super(context);
	...
	public SDSimpleProjectDetailMultiItemView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init();
	...
	private void init()
	{
		View view = LayoutInflater.from(getContext()).inflate(R.layout.view_simple_projectdetail_multi_item, this, true);
